...
<link rel='stylesheet' href="{{asset('dashasset/vendor/fullcalendar/daygrid/main.css')}}" />
<link rel='stylesheet' href="{{asset('dashasset/vendor/fullcalendar/timegrid/main.css')}}" />
<link rel='stylesheet' href="{{asset('dashasset/vendor/fullcalendar/list/main.css')}}" />
<link rel="stylesheet" href="{{asset('dashasset/css/backend-plugin.min.css')}}">
<link rel="stylesheet" href="{{asset('dashasset/css/backende209.css?v=1.0.0')}}">
<link rel="stylesheet" href="{{asset('dashasset/css/backende209.css?v=1.0.0')}}">
<link rel="stylesheet" href="{{asset('dashasset/vendor/vanillajs-datepicker/dist/css/datepicker.css')}}">
<link rel="stylesheet" href="{{asset('dashasset/vendor/%40fortawesome/fontawesome-free/css/all.min.css')}}">
<link rel="stylesheet" href="{{asset('dashasset/vendor/line-awesome/dist/line-awesome/css/line-awesome.min.css')}}">
<link rel="stylesheet" href="{{asset('dashasset/vendor/remixicon/fonts/remixicon.css')}}">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto navbar-list align-items-center">
                         ...
                         <li class="nav-item nav-icon dropdown">
                                <a class="search-link search-toggle dropdown-toggle" href="#" id="dropdownMenuButton6"
                                ...
                                <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownMenuButton6">
                                    <div class="card shadow-none m-0 border-0">
                                        <div class=" p-0 ">
                                            <div class="create-workform p-4">
                                                <div class="form-group mb-0 d-flex position-relative "
                                                    style="align-items: center; ">
                                                    <a class="search-link mr-1" href="#">
                                                    ...
                                                    <input type="text" class="search-bar form-control1" name="search"
                                                    ...
                                                    <div class="mh-200px mh-lg-325px">
                                                        <div class="d-flex align-items-center mb-3 ">
                                                            ...
                                                            <div class="d-flex flex-column ">
                                                                <a href="#" class="  text-size mb-1">
                                                                    Jack Ryan
                                                                </a>
                                                                <span class="text-muted text-size2">OR-325548</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="d-flex align-items-center mb-3 ">
                                                            ...
                                                            <div class="d-flex flex-column ">
                                                                ...
                                                                <span class="text-muted text-size2">OR-223544</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="d-flex align-items-center mb-3 ">
                                                            ...
                                                            <div class="d-flex flex-column ">
                                                                ...
                                                                <span class="text-muted text-size2">OR-125623</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="d-flex align-items-center mb-3 ">
                                                            ...
                                                            <div class="d-flex flex-column ">
                                                                ...
                                                                <span class="text-muted text-size2">OR-662210</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="d-flex align-items-center mb-3 ">
                                                            ...
                                                            <div class="d-flex flex-column ">
                                                                ...
                                                                <span class="text-muted text-size2">OR-901020</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="d-flex align-items-center mb-3 ">
                                                            ...
                                                            <div class="d-flex flex-column ">
                                                                ...
                                                                <span class="text-muted text-size2">OR-902210</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="d-flex align-items-center mb-3 ">
                                                            ...
                                                            <div class="d-flex flex-column ">
                                                                ...
                                                                <span class="text-muted text-size2">OR-902559</span>
                                                            </div>
                                                        </div>
                                                     ...
                                                     <div class="list-item d-flex justify-content-start align-items-start">
                                                         <div class="avatar">
                                                            <div class="avatar-img avatar-success avatar-20">
                                                                <span><img class="avatar is-squared rounded-circle" src="{{asset('dashasset/images/user/2.jpg')}}" alt="2.jpg"></span>
                                                            </div>
                                                        </div>
                                                        <div class="list-style-detail ml-2 mr-2">
                            ...
                            <li class="nav-item nav-icon dropdown">
                                ...
                                <img src="{{asset('dashasset/images/Flag/flag001.png')}}" class="img-fluid rounded-circle" alt="user" style="height: 30px; min-width: 30px; width: 30px;">
                                <span class="bg-primary"></span>
                                </a>
                                    ...
                                    <div class="card shadow-none m-0 border-0">
                                        <div class=" p-0 ">
                                            <ul class="dropdown-menu-1 list-group list-group-flush">
                                                <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="{{asset('dashasset/images/Flag/flag-03.png')}}" alt="img-flaf" class="img-fluid mr-2" style="width: 15px;height: 15px;min-width: 15px;"/>Spanish</a></li>
                                                <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="{{asset('dashasset/images/Flag/flag-04.png')}}" alt="img-flaf" class="img-fluid mr-2" style="width: 15px;height: 15px;min-width: 15px;"/>Italian</a></li>
                                                <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="{{asset('dashasset/images/Flag/flag-02.png')}}" alt="img-flaf" class="img-fluid mr-2" style="width: 15px;height: 15px;min-width: 15px;"/>French</a></li>
                                                <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="{{asset('dashasset/images/Flag/flag-05.png')}}" alt="img-flaf" class="img-fluid mr-2" style="width: 15px;height: 15px;min-width: 15px;"/>German</a></li>
                                                <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="{{asset('dashasset/images/Flag/flag-06.png')}}" alt="img-flaf" class="img-fluid mr-2" style="width: 15px;height: 15px;min-width: 15px;"/>Japanese</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="nav-item nav-icon dropdown">
                                <a href="#" class="nav-item nav-icon dropdown-toggle pr-0 search-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                                    <img src="{{asset('dashasset/images/user/1.jpg')}}" class="img-fluid avatar-rounded" alt="user">
...
<!-- Backend Bundle JavaScript -->
 ...
 <!-- Flextree Javascript-->
 <script src="{{asset('dashasset/js/flex-tree.min.js')}}"></script>
 <script src="{{asset('dashasset/js/tree.js')}}"></script>

 <!-- Table Treeview JavaScript -->
 <script src="{{asset('dashasset/js/table-treeview.js')}}"></script>

 <!-- SweetAlert JavaScript -->
 <script src="{{asset('dashasset/js/sweetalert.js')}}"></script>

 <!-- Vectoe Map JavaScript -->
 <script src="{{asset('dashasset/js/vector-map-custom.js')}}"></script>

 <!-- Chart Custom JavaScript -->
 <script src="{{asset('dashasset/js/customizer.js')}}"></script>

 <script src="{{asset('dashasset/vendor/Leaflet/leaflet.js')}}"></script>

 <script src="{{asset('dashasset/vendor/vanillajs-datepicker/dist/js/datepicker-full.js')}}"></script>

 <script src="{{asset('dashasset/js/charts/progressbar.js')}}"></script>

 <!-- Chart Custom JavaScript -->
 <script src="{{asset('dashasset/js/chart-custom.js')}}"></script>
 <script src="{{asset('dashasset/js/charts/01.js')}}"></script>
 <script src="{{asset('dashasset/js/charts/02.js')}}"></script>

 <!-- slider JavaScript -->
 <script src="js/slider.js"></script>

 <!-- Emoji picker -->
 <script src="{{asset('dashasset/vendor/emoji-picker-element/index.js')}}" type="module"></script>
  <!-- app JavaScript -->
 <script src="{{asset('dashasset/js/app.js')}}"></script>
<script>
(function($) {
    "use strict";
