    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb p-0 mb-0">
                                <li class="breadcrumb-item"><a href="https://templates.iqonic.design/datum/laravel/backend/Bike.html">Bikes</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Edit Bike</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-lg-12 mb-3">
                <h4 class="font-weight-bold">New Bike</h4>
            </div>
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3">
                            <div class="col-md-6 mb-3">
                                <label for="Text1" class="form-label font-weight-bold text-muted text-uppercase">Bike Name</label>
                                <input type="text" class="form-control" id="Text1" placeholder="Enter Bike Name">
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="Text2" class="form-label font-weight-bold text-muted text-uppercase">Bike Code</label>
                                <input type="text" class="form-control" id="Text2" placeholder="Enter Bike Code">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="Text3" class="form-label font-weight-bold text-muted text-uppercase">Bike Sku</label>
                                <input type="text" class="form-control" id="Text3" placeholder="Enter Bike SKU">
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-12 mb-3">
                                <label for="Text8" class="form-label font-weight-bold text-muted text-uppercase">Tag</label>
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="font-weight-bold mb-3">Bike Image</h5>
                        <div class="card-body bg-secondary rounded">
                            <div class="d-flex justify-content-center mt-5">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" height="120px" x="0px" y="0px" viewBox="0 0 419.2 419.2" style="enable-background:new 0 0 419.2 419.2;" xml:space="preserve" stroke="currentColor">
                                    <g>
                                        <g>
                                            <g>
                            ...
                            <div class="d-flex justify-content-center mt-2 mb-5">
                                <p class="mb-0 text-muted font-weight-bold">Drop files here or click to upload</p>
                            </div>
                        </div>
