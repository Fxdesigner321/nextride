    ...
    <div class="container-fluid">
        <div class="row">
                   ...
                   <div class="d-flex align-items-center justify-content-between">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb p-0 mb-0">
                                <li class="breadcrumb-item"><a href="{{url('/dashboard/bike')}}">bikes</a></li>
            ...
            <div class="col-lg-12 mb-3 d-flex justify-content-between">
                <h4 class="font-weight-bold0 d-flex align-items-center">Add New bike</h4>
                <a href="{{url('/dashboard/bike')}}" class="btn btn-primary btn-sm d-flex align-items-center justify-content-between">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            @endif
                            <div class="col-md-9">
                                <form action="{{url('/dashboard/bike/store')}}" method="POST"  enctype="multipart/form-data" class="row g-3 date-icon-set-modal">
                                    @csrf
                                    <div class="col-md-6 mb-3">
                                        <label for="Text1" class="form-label font-weight-bold text-muted text-uppercase">User</label>
                                        <input type="text" class="form-control" id="Text1" name="user_id" placeholder="Enter User">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="Text1" class="form-label font-weight-bold text-muted text-uppercase">Make</label>
                                        <input type="text" class="form-control" id="Text1" name="make" placeholder="Enter Make">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="Text5" class="form-label font-weight-bold text-muted text-uppercase">Model</label>
                                        <input type="text" class="form-control" id="Text5" name="model" placeholder="Enter Model">
                                    </div>
                                    <div class="col-md-6 mb-3 position-relative">
                                        <label for="Text2" class="form-label font-weight-bold text-muted text-uppercase">Year</label>
                                        <input type="text" class="form-control" id="Text2" name="year_id" placeholder="Enter year" autocomplete="off">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="Text4" class="form-label font-weight-bold text-muted text-uppercase">License Plate</label>
                                        <input type="text" class="form-control" id="Text4" name="license_plate" placeholder="Enter License Plate">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="Text5" class="form-label font-weight-bold text-muted text-uppercase">Color</label>
                                        <input type="text" class="form-control" name="color" id="Text5" placeholder="Enter Color Name">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="Text5" class="form-label font-weight-bold text-muted text-uppercase">Type</label>
                                        <input type="text" class="form-control" name="type_id" id="Text5" placeholder="Enter Type">
                                    </div>
                                    <div class="col-md-6">
