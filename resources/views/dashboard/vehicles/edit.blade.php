    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb p-0 mb-0">
                                <li class="breadcrumb-item"><a href="https://templates.iqonic.design/datum/laravel/backend/Vehicle.html">Vehicles</a></li>
            ...
            <div class="col-lg-12 mb-3">
                <h4 class="font-weight-bold">New Vehicle</h4>
            </div>
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3">
                            <div class="col-md-6 mb-3">
                                <label for="Text1" class="form-label font-weight-bold text-muted text-uppercase">Vehicle Name</label>
                                <input type="text" class="form-control" id="Text1" placeholder="Enter Vehicle Name">
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="Text2" class="form-label font-weight-bold text-muted text-uppercase">Vehicle Code</label>
                                <input type="text" class="form-control" id="Text2" placeholder="Enter Vehicle Code">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="Text3" class="form-label font-weight-bold text-muted text-uppercase">Vehicle Sku</label>
                                <input type="text" class="form-control" id="Text3" placeholder="Enter Vehicle SKU">
                            </div>
                            <div class="col-md-6 mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="font-weight-bold mb-3">Vehicle Image</h5>
