                    ...
                    <div class="create-workform">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            <div class="modal-product-search d-flex">
                                ...
                                <a href="{{url('dashboard/driver/add')}}"
                                        ...
                                        <td class="">
                                            <div class="active-project-1 d-flex align-items-center mt-0 ">
                                                ...
                                                <div class="data-content">
                                                    {{-- <div>
                                                        <span class="font-weight-bold">{{$item->fname . $item->lname}}</span>
                                                    </div> --}}
                                                </div>
                                            </div>
                                        </td>
                                        <td>{{$item->cnic_front_side}}</td>
                                        <td>{{$item->cnic_back_side}}</td>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-end align-items-center">
                                                ...
                                                <a class="badge bg-danger" data-toggle="tooltip" data-placement="top"
                                                   title="" data-original-title="Delete" href="{{url('dashboard/driver/delete')}}/{{$item->id}}">
