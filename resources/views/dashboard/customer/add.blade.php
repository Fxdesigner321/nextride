    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12 mb-3 d-flex justify-content-between">
                ...
                <a href="{{url('dashboard/customer')}}" class="btn btn-primary btn-sm d-flex align-items-center justify-content-between">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            @endif
                            <div class="col-md-9">
                                <form action="{{url('/dashboard/customer/store')}}" method="POST"  enctype="multipart/form-data" class="row g-3 date-icon-set-modal">
                                    @csrf
